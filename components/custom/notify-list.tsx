...
import { AnimatedList } from "../anim/anim-list";
...
export function NotifyList({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "relative flex h-[400px] flex-col md:pr-10 overflow-hidden md:shadow-xl",
        className,
      )}
    >
      <AnimatedList>
